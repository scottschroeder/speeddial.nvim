...
describe("speeddial.stream", function()
  local Stream = require("speeddial.stream").Stream
  local AsyncStream = require("speeddial.stream").AsyncStream
  local AsyncListStream = require("speeddial.stream").AsyncListStream
