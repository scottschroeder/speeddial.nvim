...
local Job = lazy.access("speeddial.job", "Job") ---@type speeddial.Job|LazyModule
...
function M.input(prompt, opt)
  ...
  if type(completion) == "function" then
    SpeeddialGlobal.state.current_completer = completion
    completion = "customlist,Speeddial__ui_input_completion"
  end
