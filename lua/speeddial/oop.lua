...
---@generic T : speeddial.Object
---@generic U : speeddial.Object
---@param name string
---@param super_class? T
---@return U new_class
...
---@field class table|speeddial.Object
---@field super_class table|speeddial.Object
